					...
					<div class="aa-product-area">
						<div class="aa-product-inner">
							...
							<ul class="nav nav-tabs aa-products-tab">
								<li class="active"><a href="#raucu" data-toggle="tab">Thực phẩm</a></li>
								<li><a href="#hat" data-toggle="tab">Thời trang</a></li>
								<li><a href="#traicay" data-toggle="tab">Đồ công nghệ </a></li>
								<li><a href="#matong" data-toggle="tab">Đồ gia dụng</a></li>
							</ul>
							<!-- Tab panes -->
					...
					<ul class="aa-testimonial-slider">
						...
						<li>
							<div class="aa-testimonial-single">
								<img class="aa-testimonial-img" src="${url}/images/a1.jpg"
									alt="avatar 1"> <span
									class="fa fa-quote-left aa-testimonial-quote"></span>
								<p>Chúng tôi đem đến cho người dùng Việt Nam những sản phẩm tốt nhất với giá cả tốt nhất</p>
						...
						<li>
							<div class="aa-testimonial-single">
								<img class="aa-testimonial-img" src="${url}/images/a2.jpg"
									alt="avatar 2"> <span
									class="fa fa-quote-left aa-testimonial-quote"></span>
						...
						<li>
							<div class="aa-testimonial-single">
								<img class="aa-testimonial-img" src="${url}/images/a3.jpg"
									alt="avatar 3"> <span
									class="fa fa-quote-left aa-testimonial-quote"></span>
