				...
				<ul class="seq-canvas">
					...
					<li>
						...
						<div class="seq-title">
							...
							<p data-seq>Best Price chính thức trở thành đại diện của Nike
								và Adidas tại Việt Nam</p>
							<a data-seq
					...
					<li>
						<div class="seq-model">
							<img data-seq src="${url}/images/slide_4.jpg"
					...
					<li>
						<div class="seq-model">
							<img data-seq src="${url}/images/slide_2.jpg"
					...
					<li>
						...
						<div class="seq-title">
							...
							<p data-seq>Là sản phẩm được gia công thủ công 100%. Chất
